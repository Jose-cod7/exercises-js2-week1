...
var coffeeMachine = {
    ...
    insertMoney: function(amount) {
        ...
        //this.insertedAmount += amount; *note: "Use when restore the insert amount in the next function"
    },
    getCoffee: function(coffee) {
        if (this.insertedAmount >= this.prices[coffee]) {
            //this.insertedAmount = 0; *note
...
coffeeMachine.prices.flatWhite;
coffeeMachine.prices["flatWhite"];

const variableString = "flatWhite";
coffeeMachine.prices[variableString];
